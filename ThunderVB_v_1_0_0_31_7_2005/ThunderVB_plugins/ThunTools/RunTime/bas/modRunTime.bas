...
Public Const PLUGIN_NAME As String = "ASM/C RunTime"
Public Const MSG_TITLE As String = PLUGIN_NAME

Public Const PLUGIN_NAMEs As String = "RunTime"
...
Public Sub AddMe2Menu()
    ...
    If hButtonID = 0 Then hButtonID = oThunVB.Add2ToolBar(oMe, PLUGIN_NAMEs, PLUGIN_NAMEs, frmRunTime.picBut.Picture)
