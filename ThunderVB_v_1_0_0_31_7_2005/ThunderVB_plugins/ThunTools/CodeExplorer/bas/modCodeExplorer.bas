Attribute VB_Name = "modCodeExplorer"
Option Explicit

Public oThunVB As ThunderVB_base
Public oMe As plugin

Public Const PLUGIN_NAME As String = "ASM Code Explorer"
Public Const MSG_TITLE As String = PLUGIN_NAME

Public Const PLUGIN_NAMEs As String = "CodeExplorer"
...
Public Sub AddMe2Menu()
    ...
    If hButtonID = 0 Then hButtonID = oThunVB.Add2ToolBar(oMe, PLUGIN_NAMEs, PLUGIN_NAMEs, frmCodeExplorer.picBut.Picture)
