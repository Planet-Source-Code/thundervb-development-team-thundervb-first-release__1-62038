...
Public Sub InitKeyWords()
    ...
    AddWord "String", COL_KEYWORD
    AddWord "Open", COL_KEYWORD
    AddWord "Close", COL_KEYWORD
    AddWord "Write", COL_KEYWORD
    AddWord "Get", COL_KEYWORD
    AddWord "Put", COL_KEYWORD
    ...
    LogMsg "Inited CopyTime Coloring ", "modCTCol", "InitKeyWords"
    LogMsg wc & " Visual Basic keywords ;" & CWc & " C keywords;" & AsmWc & " Asm keywords", "modCTCol", "InitKeyWords"
