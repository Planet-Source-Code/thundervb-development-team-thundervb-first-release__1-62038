...
' Local setting   - write "*" to the Tag property
' Default setting - write default string to the Tag property
'  note : if you use MuLtiSelect ListBox use as a delimiter of default items string - "같"
'         so Tag property of local ListBox could be .Tag = "*item1같item2같item3"
...
Private Const MULTI_SEL_LISTBOX As String = "같"
