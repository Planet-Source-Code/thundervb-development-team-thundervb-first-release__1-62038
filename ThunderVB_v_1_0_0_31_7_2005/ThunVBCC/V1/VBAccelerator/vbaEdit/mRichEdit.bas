...
Public Property Let RichEdit(ByVal edtThis As vbaRichEdit)
    '<EhHeader>
    On Error GoTo RichEdit_Err
    '</EhHeader>
...
RichEdit_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.mRichEdit.RichEdit " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Property
Public Property Get RichEdit() As vbaRichEdit
    '<EhHeader>
    On Error GoTo RichEdit_Err
    '</EhHeader>
Dim rT As vbaRichEdit
   If (m_lObj <> 0) Then
...
Public Sub ClearRichEdit()
    '<EhHeader>
    On Error GoTo ClearRichEdit_Err
    '</EhHeader>
   m_lObj = 0
    '<EhFooter>
    Exit Sub
...
ClearRichEdit_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.mRichEdit.ClearRichEdit " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Sub
...
FileMode_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.mRichEdit.FileMode " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Property
...
Public Sub ClearStreamText()
    '<EhHeader>
    On Error GoTo ClearStreamText_Err
    '</EhHeader>
    m_sText = ""
    '<EhFooter>
    Exit Sub
...
ClearStreamText_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.mRichEdit.ClearStreamText " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Sub
...
StreamText_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.mRichEdit.StreamText " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Property
...
Public Function LoadCallBack( _
    ...
    '<EhHeader>
    On Error GoTo LoadCallBack_Err
    '</EhHeader>
Dim sBuf As String
Dim B() As Byte
Dim lLen As Long
...
LoadCallBack_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.mRichEdit.LoadCallBack " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Function
Public Function SaveCallBack( _
    ...
    '<EhHeader>
    On Error GoTo SaveCallBack_Err
    '</EhHeader>
Dim sBuf As String
Dim B() As Byte
Dim lLen As Long
...
SaveCallBack_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.mRichEdit.SaveCallBack " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Function
