...
TimerCreate_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.MTimer.TimerCreate " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Function
...
Public Function TimerDestroy(timer As CTimer) As Long
    ...
    '<EhHeader>
    On Error GoTo TimerDestroy_Err
    '</EhHeader>
...
TimerDestroy_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.MTimer.TimerDestroy " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Function
...
TimerProc_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.MTimer.TimerProc " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Sub
...
StoreTimer_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.MTimer.StoreTimer " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Function
