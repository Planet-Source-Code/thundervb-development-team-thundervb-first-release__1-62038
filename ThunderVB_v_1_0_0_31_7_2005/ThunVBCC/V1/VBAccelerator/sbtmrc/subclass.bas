...
CurrentMessage_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.MSubclass.CurrentMessage " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Property
...
ErrRaise_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.MSubclass.ErrRaise " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Sub
...
AttachMessage_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.MSubclass.AttachMessage " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Sub
...
DetachMessage_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.MSubclass.DetachMessage " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Sub
...
WindowProc_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.MSubclass.WindowProc " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Function
...
CallOldWindowProc_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.MSubclass.CallOldWindowProc " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Function
...
Function IsWindowLocal(ByVal hwnd As Long) As Boolean
    '<EhHeader>
    On Error GoTo IsWindowLocal_Err
    '</EhHeader>
    Dim idWnd As Long
...
IsWindowLocal_Err:
    MsgBox Err.Description & vbCrLf & _
           "in ThunVBCC_v1_0.MSubclass.IsWindowLocal " & _
           "at line " & Erl
    Resume Next
    '</EhFooter>
End Function
