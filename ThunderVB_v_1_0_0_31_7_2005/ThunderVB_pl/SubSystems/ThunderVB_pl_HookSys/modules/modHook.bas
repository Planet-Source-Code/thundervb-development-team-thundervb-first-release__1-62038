...
TrogleHook_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "TrogleHook"
    '</EhFooter>
End Function
...
Hook_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "Hook"
    '</EhFooter>
End Function
...
Public Function HookDLLImport(sImportingModuleName As String, _
    ...
    lpImportingModuleHandle = A_GetModuleHandle(sImportingModuleName)
    ...
    If VarType(vCallNameOrAddress) = vbString Then
        ...
        lpExportingModuleHandle = A_GetModuleHandle(sExportingModuleName)
...
HookDLLImport_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "HookDLLImport"
    '</EhFooter>
End Function
...
Deref_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "Deref"
    '</EhFooter>
End Function
...
GetAddress_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "GetAddress"
    '</EhFooter>
End Function
...
EnumerateModules_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "EnumerateModules"
    '</EhFooter>
End Function
...
AddDllHookEntryToList_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "AddDllHookEntryToList"
    '</EhFooter>
End Sub
...
NewDllHook_entry_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "NewDllHook_entry"
    '</EhFooter>
End Function
...
Dim Temp As Long
    ...
    If Temp = 0 Then
        'LogMsg "Unable to set " & funct & " Hook (" & Trim$(Todll) & ") " & ErrorString, "modHook", "SetHookAndRet"
    Else
        'LogMsg funct & " Hook was set (" & Trim$(Todll) & ")", "modHook", "SetHookAndRet"
...
SetHookAndRet_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "SetHookAndRet"
    '</EhFooter>
End Function
...
KillHookList_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "KillHookList"
    '</EhFooter>
End Sub
...
CreateHookList_int_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "CreateHookList_int"
    '</EhFooter>
End Sub
...
AddToHookCol_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "AddToHookCol"
    '</EhFooter>
End Sub
...
UnHookEverything_Err:
    LogMsg "Error : " & Err.Description & " , At " & Add34(Err.Source) & ":" & Erl, "modHook", "UnHookEverything"
    '</EhFooter>
End Sub
